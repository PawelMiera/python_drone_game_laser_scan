...
class DroneState:
    ...
    def make_step(self, req_speed_x, req_speed_y):
        self.req_speed_x = req_speed_x * self.max_speed
        self.req_speed_y = req_speed_y * self.max_speed
        ...
        self.pos += np.array([new_pos_x, new_pos_y]).astype(np.float)
